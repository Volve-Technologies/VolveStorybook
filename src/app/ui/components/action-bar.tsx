...
import { useComposedRefs } from '@/app/ui/compose-refs';
import { useAsRef } from '@/app/ui/hooks/use-as-ref';
    ...
    <ActionBarContext.Provider value={contextValue}>
      {ReactDOM.createPortal(
        <div
          ...
          ref={composedRef}
          className={cn(
            'fixed z-2 rounded-lg border bg-white shadow-lg outline-none',
            'animate-slide-in',
...
function ActionBarXClose(props: ActionBarCloseProps) {
  return (
    <ActionBarClose size="sm" variant="ghost" kind="icon" className="-mr-2" {...props}>
