      ...
      >
        {toasts.map((toast) => {
          ...
          return (
            <Toast.Root
              className={cn(
                'absolute z-[calc(9999-var(--toast-index))] h-(--toast-calc-height) w-full select-none rounded-lg border bg-background bg-clip-padding shadow-lg [transition:transform_.5s_cubic-bezier(.22,1,.36,1),opacity_.5s,height_.15s] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:bg-clip-border dark:before:shadow-[0_-1px_--theme(--color-white/8%)]',
              ...
              <Toast.Content className="pointer-events-auto flex items-center justify-between gap-1.5 overflow-hidden px-3.5 py-3 text-sm transition-opacity duration-250 data-behind:pointer-events-none data-behind:opacity-0 data-expanded:opacity-100">
                <div className="flex gap-2">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <Toast.Description className="text-muted" data-slot="toast-description" />
                  </div>
                </div>
                {toast.actionProps && (
                  <Toast.Action
        ...
        {toasts.map((toast) => {
          ...
          return (
            ...
            >
              <Toast.Root
                className={cn(
                  'relative text-balance border bg-background bg-clip-padding text-xs transition-[scale,opacity] data-ending-style:scale-98 data-starting-style:scale-98 data-ending-style:opacity-0 data-starting-style:opacity-0',
                  tooltipStyle ? 'rounded-md shadow-black/5 shadow-md' : 'rounded-lg shadow-lg',
                )}
